...
public class epsnfa{
	...
	int[] union(int s1,int t1,int s2,int t2)
	{
        ...
        int sn = incCapacity();
        int tn = incCapacity();
        addEdge(sn, epssymbol, s1);
        addEdge(sn, epssymbol, s2);
        addEdge(t1, epssymbol, tn);
        addEdge(t2, epssymbol, tn);
        st[0] = sn;
        st[1] = tn;
	...
	int[] clo(int s,int t)
	{
        ...
        int sn = incCapacity();
        int tn = incCapacity();
        addEdge(sn, epssymbol, tn);
        addEdge(sn, epssymbol, s);
        addEdge(t, epssymbol, tn);
        */
